...
<a href="deliveryreport.php" class="nmclick" >Delivary</a>
<div>
...
if(isset($_POST['showo']))
{
	...
	$query = mysql_query ("SELECT * from bill where orddate>= '$fromdate' && orddate<= '$todate' order by orddate asc "); 
 ...
 <td height="30" data-label="F Name" ><?php echo $bid ?></td>
  <td height="30" data-label="F Name" ><?php echo ($idsh->cid) ?></td>
      ...
      <td  data-label="L Name"><?php echo ($idsh->billamount)-($idsh->advance) ?></td>
